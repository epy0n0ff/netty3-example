...
public class EncoderErrorTest {
  ...
  public void errorTest() throws IOException {
    ...
    handlers.add(new NamedChannelHandler("testErrorEncoder", new ErrorEncoder()));
  ...
  class ErrorEncoder extends OneToOneEncoder {

    private final Logger logger = LoggerFactory.getLogger(ErrorEncoder.class);
